...
KNOWN_SW = {
    ...
    b"10SW004672": "RXP/RXT 300hp SC (2016) — [NEMA DUMPA, nije binarno verificirano]",
    b"10SW004675": "RXP/RXT 300hp SC 2016 ORI (VERIFICIRAN dump 2026-03-20) — fuel map @ 0x022016 (ne 0x022066!), rev=8072RPM @ 0x028E44/0x028E94, SC bypass 0x3333 @ 0x0205A8",
    b"10SW000776": "215hp SC 2016 4TEC 1503 ORI (VERIFICIRAN dump 2026-03-20) — stariji ME17 format; SC bypass 0x2020 @ 0x012C60; SW=000776 je 2 manje od 260hp (000778) — ista gen, ~9305B razlike",
    b"10SW012999": "230hp SC 2017 4TEC 1503 ORI (VERIFICIRAN dump 2026-03-20) — parcijalna 2018 migracija: SC bypass/ign/rev/sc_corr/kfped/lambda_main RADE na 2018 adresama; boost/temp_fuel/lambda_trim/torque na drugačijim adresama; fuel_2d@0x022066 vjerojatno radi; rev=8072RPM@0x028E94 (jedna kopija)",
    b"10SW000778": "RXT-X 260hp SC 2016 4TEC 1503 ORI (VERIFICIRAN dump 2026-03-20) — stariji ME17 format, CODE adrese razlikuju od 2018+; SC bypass 0x2020 @ 0x012C60; ~1330B razlike od 1037524060",
    b"10SW012502": "1503 260hp SC 2017 ORI (VERIFICIRAN dump 2026-03-20) — CODE layout = 2016 gen stil (SC bypass 0x2020 @ 0x012C60, 0x0205A8=0xFFFF); 445KB razlika od 230hp 2017 (10SW012999); ne migriran na 2018 adrese; SW=12502 (497 manje od 230hp gen 012999 = raniji build)",
    b"10SW082806": "300hp SC variant (backup_flash) — [NEMA DUMPA, nije binarno verificirano]",
    ...
    b"1037544876": "NPRo Spark 900 ACE Stage 2 (decimalni SW format, BOOT djelomično promijenjen)",
}
